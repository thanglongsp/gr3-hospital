        ...
        @foreach($posts as $post)
            ...
            <div class="divPostUser">
                ...
                <div id="comment{{ $post->id }}" class="panel-collapse collapse">
                    ...
                    <!-- show bình luận -->
                    <div>
                    @foreach($comments->sortByDescsortByDesc('created_at') as $cmt)
                        @if($cmt->post_id == $post->id )
                            ...
                            <div>
                                ...
                                @if($cmt->picture != NULL)
                                <img class="mr-3 img-responsive" src="{{asset('images/comments/'.$cmt->picture)}}" alt="Generic placeholder image" style="background: #dddddd; border-radius: 5%; border: 2px solid #a1a1a1; height: 150px; text-align: center; width: 200px;">
                                @endif
                            </div>
                        @endif
                    @endforeach
