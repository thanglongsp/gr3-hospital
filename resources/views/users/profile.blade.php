            ...
            <div style="margin-left:-200px">
                ...
                <div id="Hồ sơ bệnh án" class="tabcontent" style="display:none">
                    <div class="ex1">
                        ...
                        <p>~~~</p> 
                        <p>abc xyz.</p>
                        <p> <a href="#" style="margin-left:90%; color: blue;" data-toggle="modal" data-target="#test">chi tiết</a>
                    <!-- Modal bệnh án nội khoa -->
                    <div class="modal fade" id="test" role="dialog" style="margin-left: -350px;">
                        <div class="modal-dialog">
                        <!-- Modal content-->
                            <div class="modal-content">
                                <div class="modal-header">
