...
<div class="col-sm-12">
    <div class="col-sm-4">
        <div class="condition">
            ...
            <br>
            <center>
                <button id="findBtn" class="btn btn-success" style="width: 100%;">Xem kết quả</button>
            </center>
        </div>
    </div>
    <div class="col-sm-8">
                ...
                <p type="hidden" value="{{ $dem = 1 }}">
                    <div class="myDivResultChild">
                        <ul>
                            ...
                            @if( $rq->ma_chuyen_mon == $test->ma_chuyen_mon && $rq->ngay_thu == $date && $rq->cach_thuc
                            == $test->ma_cach_thuc)
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-3">
                        <a href="#" data-toggle="modal"
                           data-target="#dat_lich{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
                           style="margin-left:40%;">Đặt lịch</a>
                    </div>
                    <div class="col-sm-6 col-xs-3">
                        <a href="#" data-toggle="modal" data-target="#{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
                           style="margin-left:50%;">Chi tiết</a>
                    </div>
                </div>
            </div>
            <!-- Modal Đặt lịch -->
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-3">
                    <p><a href="#" data-toggle="modal"
                          data-target="#dat_lich{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}" style="margin-left:40%;">Đặt
                            lịch</a>
                </div>
                <div class="col-sm-6 col-xs-3">
                    <a href="#" data-toggle="modal" data-target="#{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
...
<div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-6 col-xs-3">
            <p><a href="#" data-toggle="modal" data-target="#dat_lich{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
                  style="margin-left:40%;">Đặt lịch</a>
        </div>
        <div class="col-sm-6 col-xs-3">
            <a href="#" data-toggle="modal" data-target="#{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
...
<div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-6 col-xs-3">
            <a href="#" data-toggle="modal" data-target="#dat_lich{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
               style="margin-left:40%;">Đặt lịch</a>
        </div>
        <div class="col-sm-6 col-xs-3">
            <a href="#" data-toggle="modal" data-target="#{{ $test->ma_chuyen_mon.$test->ma_cach_thuc}}"
